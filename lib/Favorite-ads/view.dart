    ...
    return Obx(
      () => RefreshIndicator(
        ...
        child: Container(
          ...
          child: controller.favad.isNotEmpty
              ? GridView.builder(
                  shrinkWrap: true,
                    ...
                    return InkWell(
                      onTap: () {
                        Map details = {
                          ...
                          'adphone':
                              controller.favad[index].ad![0].adPhoneNumber,
                          'addescr':
                              controller.favad[index].ad![0].adDescription,
                          'adpicture': controller.favad[index].ad![0].adPicture,
                          'adprice': controller.favad[index].ad![0].adPrice,
                          'created': controller.favad[index].ad![0].createdAt,
                          'updated': controller.favad[index].ad![0].updatedAt,
                        };
                        Get.to(() => Adsdetails(
                              details: details,
                            ));
